...
tf.flags.DEFINE_float('beta2', 1,
                      'weight of difference between fake_y and x, default: 1')
...
def train():
  ...
  with graph.as_default():
    ...
    optimizers = cycle_gan.optimize(G_loss, D_Y_loss, F_loss, D_X_loss, step_)
  ...
  with tf.Session(graph=graph) as sess:
    ...
    if FLAGS.load_model is not None:
      ...
      #meta_graph_path = checkpoints_dir + "/model.ckpt-240334.meta"
